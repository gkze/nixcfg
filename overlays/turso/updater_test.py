"""Focused tests for the Turso updater."""
...
def _load_module() -> ModuleType:
    return load_repo_module(
        "overlays/turso/updater.py",
        "turso_updater_dedicated_test",
    )


def test_turso_validates_the_updated_package_build() -> None:
    """The updater should realize Turso after refreshing its hashes."""
    module = _load_module()

    assert module.TursoUpdater.get_derivation_validations() == (
...
def test_turso_computes_source_then_cargo_hash(
