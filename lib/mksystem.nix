...
sysFn {
  ...
  modules =
    ...
    ++ optionals (device != null && pathExists ../device/system/${device}.nix) [
    ...
    ++ filter (e: e != null) (
      map (u: if pathExists ../user/${u}/system.nix then ../user/${u}/system.nix else null) users
    )
        ...
        home-manager = {
          ...
          extraSpecialArgs = {
            ...
            hmMods =
              ...
              optionals (device != null && pathExists ../device/home/${device}.nix) [
