...
class BuildResult1(BaseModel):
    times_built: Annotated[
        int | None, Field(alias="timesBuilt", ge=0, title="Times built")
    ] = None
    start_time: Annotated[
        int | None, Field(alias="startTime", ge=0, title="Start time")
    ] = None
    stop_time: Annotated[
        int | None, Field(alias="stopTime", ge=0, title="Stop time")
    ] = None
    cpu_user: Annotated[
        int | None, Field(alias="cpuUser", ge=0, title="User CPU time")
    ] = None
    cpu_system: Annotated[
        int | None, Field(alias="cpuSystem", ge=0, title="System CPU time")
    ] = None
    ...
    built_outputs: Annotated[
        dict[str, BuiltOutputs], Field(alias="builtOutputs", title="Built outputs")
    ]
...
class BuildResult2(BaseModel):
    ...
    is_non_deterministic: Annotated[
        bool | None, Field(alias="isNonDeterministic", title="Non-deterministic flag")
    ] = None
...
class DynamicOutputs(BaseModel):
    ...
    dynamic_outputs: Annotated[
        DynamicOutputs1 | None, Field(alias="dynamicOutputs", title="Dynamic Outputs")
    ] = None
...
class AllowedReferences(BaseModel):
    ...
    drv_path: Annotated[
        Literal["self"], Field(alias="drvPath", title="This derivation")
    ] = "self"
...
class ForAllOutputs(BaseModel):
    ...
    ignore_self_refs: Annotated[
        bool, Field(alias="ignoreSelfRefs", title="Ignore Self References")
    ]
    max_size: Annotated[int | None, Field(alias="maxSize", ge=0, title="Maximum Size")]
    max_closure_size: Annotated[
        int | None, Field(alias="maxClosureSize", ge=0, title="Maximum Closure Size")
    ]
...
class OutputChecks(BaseModel):
    ...
    for_all_outputs: Annotated[
        ForAllOutputs, Field(alias="forAllOutputs", title="Output Check Specification")
    ]
...
class DerivationOptions(BaseModel):
    ...
    output_checks: Annotated[
        OutputChecks | OutputChecks1, Field(alias="outputChecks", title="Output Check")
    ]
    ...
    additional_sandbox_profile: Annotated[
        str, Field(alias="additionalSandboxProfile", title="Additional Sandbox Profile")
    ]
    no_chroot: Annotated[bool, Field(alias="noChroot", title="No Chroot")]
    impure_host_deps: Annotated[
        list[str], Field(alias="impureHostDeps", title="Impure Host Dependencies")
    ]
    impure_env_vars: Annotated[
        list[str], Field(alias="impureEnvVars", title="Impure Environment Variables")
    ]
    allow_local_networking: Annotated[
        bool, Field(alias="allowLocalNetworking", title="Allow Local Networking")
    ]
    ...
    prefer_local_build: Annotated[
        bool, Field(alias="preferLocalBuild", title="Prefer Local Build")
    ]
    allow_substitutes: Annotated[
        bool, Field(alias="allowSubstitutes", title="Allow Substitutes")
    ]
...
class StoreObjectInfoV23(BaseModel):
    ...
    download_size: Annotated[
        int, Field(alias="downloadSize", ge=0, title="Download Size")
    ]
