...
def test_agentic_source_pins_copilot_gpt55_and_safe_outputs() -> None:
    """The source workflow uses Copilot GPT-5.5 and deterministic safe outputs."""
...
def test_compiled_agentic_lock_tracks_source_and_gpt55() -> None:
    """The checked-in lock file is compiled from the GPT-5.5 source workflow."""
